...
export function PingReply(userIP: string, data: any) {
  const embed = new EmbedBuilder()
    ...
    .addFields(
      ...
      { name: '🔹 ASN', value: data.asn?.asn || 'N/A', inline: true },
      { name: '🕒 Timezone', value: data.timezone || 'N/A', inline: true },
      { name: '🌐 Location (Lat/Lon)', value: data.loc || 'N/A', inline: true },
      { name: '📧 Reverse DNS', value: data.hostname || 'N/A', inline: true },
      {
        name: '🔍 Abuse Info',
